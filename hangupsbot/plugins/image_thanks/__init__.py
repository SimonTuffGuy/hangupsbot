...
def _initialise(bot):
    plugins.register_user_command(["thanks"])
...
def thanks(bot, event, *args):
    ...
    try:
        jpg_link = '/plugins/image_thanks/sadobama.jpg'
        # plugin_dir = os.path.dirname(os.path.realpath(__file__))
        # jpg_link = plugin_dir + "/" + jpg_link
        # print(plugin_dir)

        # name = " ".join(args)    
        # topString = "Thanks " + name

        # make_meme(topString, '', jpg_link)
